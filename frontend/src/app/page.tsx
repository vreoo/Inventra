    ...
    <main className="relative isolate min-h-screen overflow-x-hidden bg-slate-950 text-slate-100">
      ...
      <div className="mx-auto flex  max-w-6xl flex-col px-6 pb-24 pt-10 ">
        ...
        <section className="mt-20 grid gap-12 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
          <div className="space-y-7">
            ...
            <div className="space-y-6">
              <SplitText
                ...
                className="font-semibold leading-tight text-white sm:text-5xl md:text-6xl"
                duration={0.8}
                delay={200}
                splitType="words"
                ease="power3.out"
            ...
            <div className="flex flex-col items-start gap-3 sm:flex-row">
              <Button
                asChild
                size="lg"
                className="cursor-target group bg-cyan-400 text-slate-950 shadow-lg shadow-cyan-400/30 transition-transform hover:translate-y-0.5 hover:bg-cyan-300"
              >
                <Link href="/upload">
                  Start uploading
              ...
              <Button
                ...
                size="lg"
                variant="ghost"
                className="cursor-target text-slate-300 hover:text-black"
              >
          ...
          <SpotlightCard
            className={cn(
              "cursor-target h-full p-8 bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.10),_rgba(15,23,42,1)_80%)]"
            )}
