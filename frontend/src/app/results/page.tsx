      ...
      <>
        ...
        <div className="mb-6 grid gap-4 md:grid-cols-2">
          <div className="rounded-md border border-gray-200 bg-white p-4 text-sm">
            <h3 className="font-semibold text-gray-700">Job Context</h3>
            ...
            <div className="rounded-md border border-blue-200 bg-blue-50 p-4 text-sm text-blue-900">
              ...
              <div className="mt-2 space-y-1">
                {jobData.validation.detected_frequency && (
                  <div>
                    Frequency detected: {jobData.validation.detected_frequency}
                  </div>
                )}
        ...
        <div className="space-y-8">
          {jobData.results.map((result, index) => {
            ...
            const chartData = forecastPointsToShow.map((point) => ({
              ...
              lower: point.lower_bound === undefined ? null : point.lower_bound,
              upper: point.upper_bound === undefined ? null : point.upper_bound,
            }));
            const previewLabel =
              ...
              >
                ...
                <p className="mb-4 text-sm text-muted-foreground">
                  ...
                  {result.demand_frequency && (
                    <span className="ml-2">
                      Frequency: {result.demand_frequency}
                    </span>
                  )}
                </p>
                  ...
                  <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    {result.peak_season && (
                      <div className="rounded-md border border-green-200 bg-green-50 p-4 text-green-900">
                        <h3 className="font-medium">Peak Season</h3>
